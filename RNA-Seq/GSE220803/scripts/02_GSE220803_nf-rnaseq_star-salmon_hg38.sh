nextflow run nf-core/rnaseq -r 3.14.0 \
    -profile docker \
    --input '../GSE220803_fq/nf-core_fetchngs/samplesheet/samplesheet.csv' \
    --outdir '../results/GSE220803_nf-rnaseq_star-salmon_hg38_results' \
    -work-dir '../results/GSE220803_nf-rnaseq_star-salmon_hg38_results/nf-rnaseq_workdir' \
	--multiqc_title 'GSE220803_nf-rnaseq_star-salmon_hg38_report' \
